...
import Imagecolor1 from "../assets/images/colors/entra/Cloudy-Grey-GreenPlank-composite-decking-color-200x200.png";
                                        ...
                                        <div className="row">
                                                ...
                                                <Grid container spacing={3}>
                                                    <Grid item xs={6} sm={2}>
                                                        <div className="single-gallery-project__image">
                                                            ...
                                                            <h4 className="mt-20 text-center">Cloudy Grey</h4>
                                                        </div>
                                                    </Grid>
                                                    <Grid item xs={6} sm={2}>
                                                        <div className="single-gallery-project__image">
                                            ...
                                            <a href="assets/pdfs/smart-classic-deck-swedish.pdf">
                                                <img src="assets/img/projects/pic.png" className="img-fluid" alt="" />
                                                    ...
                                                    <Grid item xs={6} sm={2}>
                                                        <a href="assets/pdfs/Green-Plank-Entra-Decking-System-Installation-Guide-2019.pdf">
