...
import Image1 from "../assets/images/products/innerPages/golvplattor/Untitled-2.webp";
import Head from "next/head";
import Imagecolor1 from "../assets/images/colors/instaclik-balkongplattorGp702t/Balcony-Tile-Instaclik-Composite-Antique-Oak.png";
import Imagecolor2 from "../assets/images/colors/instaclik-balkongplattorGp702t/Balcony-Tile-Instaclik-Composite-Beach-Grey.png";
import Imagecolor3 from "../assets/images/colors/instaclik-balkongplattorGp702t/Balcony-Tile-Instaclik-Composite-Chocolate-Brown.png";
import Imagecolor4 from "../assets/images/colors/instaclik-balkongplattorGp702t/Balcony-Tile-Instaclik-Composite-Teak.png";
            ...
            <Layout pageTitle="instaclik-balkongplattor-gp702t">
                ...
                <section className="blog-details pt-120 pb-40">
                    <Container>
                        <Row>
                            <Col md={12} lg={12}>
                                <div className="page-wrapper pt-60 pb-40">
                                    ...
                                    <div className="project-section">
                                        <div className="container">
                                            <div className="row">
                                                    ...
                                                    <Grid container spacing={3}>
                                                        <Grid item xs={6} sm={2}>
                                                            <div className="single-gallery-project__image">
                                                                ...
                                                                <h4 className="mt-20 text-center">Antique Oak</h4>
                                                            </div>
                                                        </Grid>
                                                        <Grid item xs={6} sm={2}>
                                                            <div className="single-gallery-project__image">
                                                        ...
                                                        <Grid item xs={6} sm={2}>
                                                            <div className="single-gallery-project__image">
                                                                ...
                                                                <h4 className="mt-20 text-center">Chocolate Brown</h4>
                                                            </div>
                                                        </Grid>
                                                        <Grid item xs={6} sm={2}>
                                                            <div className="single-gallery-project__image">
                                                ...
                                                {/*====================  Star Golvplattor Section-5 content ====================*/}
                                                <div className="col-12 mb-80">
                                                    <Grid container spacing={3}>
                                                        <Grid item xs={12} sm={4}>
                                                            <iframe width="360" height="315" src="https://www.youtube.com/embed/vcbAYC6Bgo4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                        </Grid>
                                                        <Grid item xs={12} sm={4}>
...
export default instaclikbalkongplattor;
