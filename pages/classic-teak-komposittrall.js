                                            ...
                                            <div className="row">
                                                                ...
                                                                <div className="row mt-60">
                                                                    ...
                                                                    <Grid container spacing={3}>
                                                                        ...
                                                                        <Grid item xs={6} sm={3} lg={5}>
                                                                            <a href={`${process.env.PUBLIC_URL}/assets/pdfs/Classic™Komposittrall/classic-deck-swedish.pdf`} className="thm-btn"  >installationsguide</a>
                                                                        </Grid>
                                                                        <Grid item xs={8} sm={6} lg={6}>
                                                                            <a href={`${process.env.PUBLIC_URL}/assets/pdfs/Classic™Komposittrall/classic-deck-SWEDISH-aluminim-trim.pdf`} className="thm-btn" >installation av aluminium</a>
                                                                        </Grid>
                                                                    </Grid>
                                                                </div>
                                                            </div>
                                                ...
                                                <div className="col-12 mb-30 mt-80" >
                                                    ...
                                                    <Grid container spacing={3}>
                                                        ...
                                                        <Grid item xs={6} sm={2}>
                                                            <a href="assets/pdfs/Classic™Komposittrall/classic-deck-swedish.pdf">
                                                                <img src={pdfimg2} className="img-fluid" alt="" />
                                                            </a>
                                                        </Grid>
                                                        <Grid item xs={6} sm={2}>
                                                            <a href="assets/pdfs/Classic™Komposittrall/Green-Plank-Composite-Decking-hollow-boards-Installation-Guide-2019.pdf">
                                                                <img src={pdfimg3} className="img-fluid" alt="" />
                                                            </a>
                                                        </Grid>
                                                        <Grid item xs={6} sm={2}>
                                                            <a href="assets/pdfs/Classic™Komposittrall/classic-deck-SWEDISH-aluminim-trim.pdf">
