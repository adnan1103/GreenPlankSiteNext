...
import Image11 from "../assets/images/products/innerPages/plankor/GP7119/image.webp";
...
const naturplankkompositplankagp7119 = () => {
  return (
    <Layout pageTitle="naturplank-kompositplank-gp7119-4090mm">
      <HeaderTwo />
      <StickyHeader />
      <PageHeader title="naturplank-kompositplank-gp7119-4090mm" crumbTitle="gp7119" />
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-12 col-12 mb-80 pl-30 pl-sm-15 pl-xs-15">
                                    <div className="project-details">
                                        <h2>
                                        NATURPLANK™ Kompositplank – GP7119</h2>
                                        ...
                                        <div class="et_pb_text_inner">
                                            <div class="ce_text block">
                                                ...
                                                <p>
                                                Green Plank NATURPLANK ™ komposit GP7119 med hög prestanda av naturfibrer är idealiska för olika utomhusapplikationer som uteplats, däck och trädgårdsmöbler, parkbänkar, stolar, bord, picknickbord, planterboxar, förvaring etc.
                                                </p>
                                                <p>
                                                ...
                                                <p>
                                                Precis som äkta trä kan våra NATURPLANK ™ fyrkantiga GP7119-kompositplankor slipas eller sågas till vilken önskad form som helst utan att förlora kompositskivans verkliga träeffekt.
                                                </p>
                                                <div>
                                                    <ul>
...
export default naturplankkompositplankagp7119;
