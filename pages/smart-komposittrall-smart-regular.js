                    ...
                    <div className="row">
                              ...
                              <div className="row section-space--top--60">
                                ...
                                <Grid container spacing={3}>
                                  ...
                                  <Grid item xs={6} sm={3} lg={6}>
                                    <a href={`${process.env.PUBLIC_URL}/assets/pdfs/Smart™Regular/smart-regular-Swedish%20(1).pdf`} className="thm-btn"  >installationsguide</a>
                                  </Grid>
                                  <Grid item xs={8} sm={6} lg={8}>
                                    <a href={`${process.env.PUBLIC_URL}/assets/pdfs/Smart™Regular/smart-regular-Swedish.pdf`} className="thm-btn" >installation av aluminium</a>
                                  </Grid>
                                </Grid>
                              </div>
                            </div>
                      ...
                      <div className="col-12 mb-30 mt-80" >
                        ...
                        <Grid container spacing={3}>
                          ...
                          <Grid item xs={6} sm={2}>
                            <a href="assets/pdfs/Smart™Regular/smart-regular-Swedish (1).pdf">
                              <img src={pdfimg2} className="img-fluid" alt="" />
                            </a>
                          </Grid>
                          <Grid item xs={6} sm={2}>
                            <a href="assets/pdfs/Smart-Installation-SV-1.pdf">
                              <img src={pdfimg3} className="img-fluid" alt="" />
                            </a>
                          </Grid>
                          <Grid item xs={6} sm={2}>
                            <a href="assets/pdfs/Smart™Regular/smart-regular-Swedish.pdf">
