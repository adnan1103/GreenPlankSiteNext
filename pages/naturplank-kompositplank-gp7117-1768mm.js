...
import Image11 from "../assets/images/products/innerPages/plankor/GP7117/image.webp";
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-12 col-12 mb-80 pl-30 pl-sm-15 pl-xs-15">
                        <div className="project-details">
                          <h2>
                            NATURPLANK ™ Kompositplank – GP7117 – det gröna alternativet</h2>
                          ...
                          <div class="et_pb_text_inner">
                            <div class="ce_text block">
                              ...
                              <p>
                                Green Plank NATURPLANK ™ komposit GP7117 med hög prestanda av naturfibrer är perfekta för olika utomhusapplikationer, som ledstänger, uteplats, däck och trädgårdsmöbler, parkbänkar, bord, papperskorgar och förvaring.
                              </p>
                              <p>
                              ...
                              <p>
                                Precis som äkta trä kan våra NATURPLANK ™ fyrkantiga GP7117-kompositplankor slipas eller sågas till vilken önskad form som helst utan att tappa kompositskivans verkliga träeffekt.
                              </p>
                              <div>
                                <ul>
...
export default naturplankkompositplankagp7117;
