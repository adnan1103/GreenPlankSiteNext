              ...
              <Col lg={12}>
                ...
                <div className="mb-30">
                  ...
                  <div className="row mt-30">
                    <Grid container spacing={3}>
                      <Grid item xs={12} sm={8}>
                        <a href={`${process.env.PUBLIC_URL}/assets/pdfs/grantier/GREEN-PLANK-WARRANTY-swedish-.pdf`} className="thm-btn" >Ladda Ner Garanti för privatperson</a>
                      </Grid>
                    </Grid>
                  </div>
                  ...
                  <div className="row mt-30">
                    <Grid container spacing={3}>
                      <Grid item xs={12} sm={8}>
                        <a href={`${process.env.PUBLIC_URL}/assets/pdfs/grantier/STAIN-AND-FADE-PERFORMANCE-LIMITED-WARRANTY-translated-and-corrected.pdf`} className="thm-btn" >Ladde Ner FÄRG- OCH FADE</a>
                      </Grid>
                    </Grid>
                  </div>
                  ...
                  <div className="row section-space--top--30">
                    <Grid container spacing={3}>
                      <Grid item xs={12} sm={8}>
                        <a href={`${process.env.PUBLIC_URL}/assets/pdfs/grantier/Green-Plank®-kommersiell-begransad-garanti-Translated-and-Corrected.pdf`} className="thm-btn" >Ladde Ner kommersiell begränsad garanti</a>
                      </Grid>
                    </Grid>
                  </div>
                  ...
                  <p className="mb-30 mt-30">För att validera din garanti måste du fylla i och posta (<a href="assets/pdfs/grantier/GREEN-PLANK-WARRANTY-REGISTRATION-CARD.pdf">DOWNLOAD registreringskortet</a>) inom 90 dagar efter installationen. En kopia av kvittot från en auktoriserad Green Plank AB, Green Plank® Trall -återförsäljare eller entreprenör samt ett foto av projektet krävs.</p>
                </div>
              </Col>
            </Row>
          </Container>
